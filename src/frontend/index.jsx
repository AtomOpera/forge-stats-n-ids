...
import ForgeReconciler, { Text, Em, Strong, Lozenge, Button, Stack, Image } from '@forge/react';
  ...
  return (
    <>
      <Stack alignInline='center'>
        ...
        {/* <Em>{data ? data : 'Loading...'}</Em>&nbsp;
        <Lozenge appearance='success'>Yaaay!</Lozenge>&nbsp;
        <Button>Click me!</Button>&nbsp;
        <Image src="https://go.atlassian.com/curious-cat" /> */}
      </Stack>
    </>
  );
};
